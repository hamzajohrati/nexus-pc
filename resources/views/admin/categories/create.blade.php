        ...
        <div class="card-body w-25 mx-auto">
            <form action="{{ route('admin.categories.store')}}" method="POST" class="">
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="com-md-3">
                        <input type="text" id="category" name="category" class="form-control"  aria-describedby="categoryHelpInline">
                    </div>
                    <div class="com-md-3">
                    </div>
                </div>
                <div class="row g-3 align-items-center mt-1">
                    ...
                    <div class="com-md-3">
                        <textarea id="description" name="description"  maxlength="255" class="form-control"></textarea>
                    </div>
                    <div class="com-md-3">
                    </div>
                </div>
                <div class="row g-3 align-items-center mt-1">
                    @php
                        ...
                        $current = old('icon','fa-solid fa-cog');
                    @endphp
